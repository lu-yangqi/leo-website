...
- Scroll-linked homepage Hero: large portrait → centered 58%-scale portrait → fully visible hold → centered fade-out → progressive Leo signature reveal → homepage content
...
retain the existing simultaneous portrait/signature layout without this timeline.
